...
////        //****************MOA2*********************
       ...
       String trainPath = "src\\main\\resources\\datasets\\4CRE-V2-train.arff";
       String testPath = "src\\main\\resources\\datasets\\4CRE-V2-test.arff";
       String outputDirecotory = "src\\main\\resources\\resultados_testes_2025\\"+dataSetName+"\\";
       double k_ini = 0.01;
       String theta = "150";
       String omega = "200";
       int L = 4;
...
//        float[] windowsCardinalities = DataSetUtils.getWindowsCardinalities(test, evaluationWindowSize, L);
        ...
        //Create output files
        FileWriter filePredictions = new FileWriter(new File(outputDirectory + "/faseOnlineInfo_.txt"), false); //Armazena informações da fase online
